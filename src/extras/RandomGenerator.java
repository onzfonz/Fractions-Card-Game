...
* --------------------------
* This file implements an extension to the Random class that makes it
* clearer to students that the object is a generator. The motivation
* for this class comes from submissions from Alyce Brady.
* Modified Eric Roberts Class to make it look more like the newest version
*/
...
* <code>java.util</code> that has the following advantages over the
* original:
*
* <p><ul>
...
* @param low The low end of the range
* @param high The high end of the range
* @return The next random <code>double</code> in the half-open interval [ low : high )
*/
...
/* Method: nextColor() */
/**
* Returns a random opaque <code>Color</code> whose components are chosen uniformly
* in the 0-255 range.
*
