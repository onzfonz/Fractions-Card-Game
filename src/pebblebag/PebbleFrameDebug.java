...
//		TrickCard one2Ice = new TrickCard(Constants.TWO_TWO_ICE_FILENAME, 1, 2, "Ice");
		...
		pebM = new PebbleMover(pPanel, true);
		...
		*/
		...
		final JButton oppoChooseDebug = new JButton("Choose Orange");
		box.add(oppoChooseDebug);
		oppoChooseDebug.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				pebM.choosePebbleDebug();
			}
		});
