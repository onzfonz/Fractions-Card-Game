 ...
 */
public class DragNDropMockup extends JPanel {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
	    EventQueue.invokeLater(new Runnable() {
	      public void run() {
	        ...
	        JLabel label = new JLabel(new CardIcon("cards_stink.jpg", 3, 5, "stink"));
...
//	public DragNDropMockup(int w, int h) {
...
//		
//		DragNDropMockup t = new DragNDropMockup(600, 600);
//		cont.add(t);
