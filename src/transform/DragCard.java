...
public class DragCard {
	...
	public DragCard() {
		JFrame frame = new JFrame("Drag Card");
		...
		label.setIcon(icon);
		label.setTransferHandler(new CardSelection());
...
//				}
		...
		label2.setTransferHandler(new CardSelection());
